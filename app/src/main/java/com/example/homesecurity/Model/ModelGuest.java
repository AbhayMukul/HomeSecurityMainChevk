...
public class ModelGuest {
    ...
    //Constructor for Guard All and Active.
    public ModelGuest(String keyUID, String name, String phone, String work, String flat, String dateOutCitizen, String timeOutCitizen, Boolean exitCitizen, Boolean allowed, String dateInGuard, String timeInGuard, Boolean exitGuard, String timeOutGuard, String dateOutGuard) {
        KeyUID = keyUID;
        Name = name;
        Phone = phone;
        Work = work;
    ...
    public ModelGuest(String keyUID, String name, String phone, String work, String flat, String dateOutCitizen, String dateInGuard,Boolean allowed) {
        KeyUID = keyUID;
        Name = name;
        Phone = phone;
        Work = work;
